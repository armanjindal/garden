...
The writing here, the plants growing in this garden, are not isolated, but neither are they neatly connected. They exist rooted in soil, connect by by a rhizome — a tangled mass of roots — which grow in ways I am not sure of. Tracing the genealogy of my thinking over time is a fascinating project in self-examination. This is a project I will support to the end of the internet. 

To support this lofty goal, I chose an opinionated, open-source stack to build this site. I use [Obsidian](https://obsidian.md/) to write — a [power user native](digital-garden/Independent%20Study/Power%20&%20Power%20User%20-%20Prospectus.md), personal knowledge management editor. I publish this site using an open source tool built by [Jacky Zhao](https://jzhao.xyz/) called [Quartz](https://github.com/jackyzha0/quartz#quartz) which compiles the `markdown` files in my local Obsidian vault into static HTML. All pages are versioned controlled on [GitHub](https://github.com/armanjindal/armanjindal.github.io/commit/hugo), so there is a permanent, timestamped, line-by-line record of every change. I hope to look back at the commit histories to understand how my thinking changes. These tools help me produce an expanding network of thoughts, which ultimately help me shape, affirm and faithfully **live** a narrative of my creation. 
...
Answering questions of identity are never easy.  I'd like to preface this answer with a scene from Sense8, by the Wachowski Sisters, which poignantly questions the question of identity:

[do you mean...](https://youtu.be/fR5-x7v7UkE?t=37) what I've done: 
...
Personally, I enjoy dancing and working out(doors). I need to exercise, read and write every day. I strive to open myself to being moved by people, experiences, and art. I love to travel light, cheap, and with a friend. I've played [squash competitively](https://www.youtube.com/watch?v=BZ3n9XHfAy8&t=1575s) and [climbed a mountain](https://adventure-pulse.com/mountaineering/kang-yatse-2)in Leh, India. Parts of me are are always there, and with my family and closest friends who inspire me every day.  I meditate, move, converse, program, and write about all of that here. My favorite philosopher right now is [Simone Weil](https://en.wikipedia.org/wiki/Simone_Weil) I am enjoying some of Borges' short stories, and learning a lot from [Derek Sivers](https://sive.rs/).
...
[LinkedIn](https://www.linkedin.com/in/arman-jindal-650a8616b/)

if you have an opportunity or want to chat. All I can promise is genuine curiosity, and that I will not forget to pay it forward.

Please do reach out. I will reply to every email that I get. 
